...
//             ]
// Tugas kamu adalah mengimplementasikan fungsi dataHandlingagar dapat menampilkan data-data pada dari argumen seperti di bawah ini:
...
function dataHandling(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        for (let j = 0; j < tampungI.length - 1; j++) {
