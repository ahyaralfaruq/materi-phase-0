...
if(nama === '') {
    ...
    if(peran === '') {
        ...
        if(peran.toLocaleLowerCase() === 'kesatria') {
            console.log(`Hallo ${peran} ${nama}, kamu dapat menyerang dengan senjatamu !`)
        } else if (peran.toLocaleLowerCase() === 'tabib') {
            ...
            console.log(`Maaf ${nama}. peran mu tidak ada dalam daftar game ini!. silahkan pilih peran sebagai kesatria/tabib/penyihir untuk dapat memulai game ini. terimakasih`)
        }
    }
